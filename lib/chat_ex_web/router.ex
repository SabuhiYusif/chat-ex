defmodule ChatExWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {ChatExWeb.LayoutView, :root}
  ...
  scope "/", ChatExWeb do
    ...
    resources "/rooms", RoomController, only: [:index, :new, :create, :show, :edit, :update, :delete]
  end
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: ChatExWeb.Telemetry
    end
  end
